...
breathe_default_project = "dcmt-cpp"
breathe_projects = {"dcmt-cpp": "xml"}
breathe_projects_source = {"dcmt-cpp": ("..", ["include/dcmt/dcmt.h"])}
...
#  pip install Sphinx breathe m2r2 sphinx_rtd_theme
#  cd dcmt-cpp/docs
